...
import CloseTheDomByClickBlankArea from './components';
import './index.less';

class CloseTheDomByClickBlankAreaContain extends Component {
  // static propTypes = {
...
export default CloseTheDomByClickBlankAreaContain;
